 ...
 * @author Randima
 */
public class comlexityControllSturcture extends javax.swing.JFrame {

    /**
     * Creates new form comlexityControllSturcture
     */
    public comlexityControllSturcture() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Lline NO", "Program Statement", "Wtcs", "NC", "Ccspps", "Ccs"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(comlexityControllSturcture.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new comlexityControllSturcture().setVisible(true);
            }
        });
    }
