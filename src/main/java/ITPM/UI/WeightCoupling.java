...
import static ITPM.UI.ComplexityCoupling.jTableCoupling;
import ITPM.logic.Caller;
//import static ITPM.UI.Dashboard.Dash_UploadSpace;
...
DefaultTableModel model = (DefaultTableModel)jTable1.getModel();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ComplexityCoupling cp1 = new   ComplexityCoupling();
           cp1.setVisible(true);
           this.dispose();
        
        DefaultTableModel dtm = (DefaultTableModel)jTableCoupling.getModel();
           
          // DefaultTableModel dtm2 = (DefaultTableModel)jTable1.getModel();
        
        int selectedRow = jTableCoupling.getSelectedRow();
        //jLabelChange.setText(dtm.getValueAt(selectedRow,0).toString());
        //jTextChange.setText(dtm.getValueAt(selectedRow,1).toString());
        Coupling couplingObj = Caller.analyzeCode(Dash_UploadSpace.getText());
        
        
        
        
       // int a = couplingObj.getMethodList().size();
        //System.out.println(a);
        //insert values in to tables
        dtm.setValueAt(couplingObj.getMethodList().size(),0,7);
        dtm.setValueAt(couplingObj.getMethodSetFull().size(),0,8);
        dtm.setValueAt(couplingObj.getCalledMethodList().size(),0,9);
        dtm.setValueAt(couplingObj.getGlobalVariableSet().size(),0,5);
        dtm.setValueAt(couplingObj.getGlobalVariableListInRec().size(),0,6);
       dtm.setValueAt(couplingObj.getRegularMethods().size(),0,10);
       dtm.setValueAt(couplingObj.getRecursiveMethods().size(),0,0);
        dtm.setValueAt(couplingObj.getRegularInRegularMethods().size(),0,1);
        dtm.setValueAt(couplingObj.getRegularInRecursiveMethods().size(),0,2);
          dtm.setValueAt(couplingObj.getRecursiveInRecursiveMethods().size(),0,3);
       dtm.setValueAt(couplingObj.getRecursiveInRegularMethods().size(),0,4);
     
       
       //dtm.setValueAt(a,0,1);dtm.setValueAt(a,1,2);
